 ...
 * @author Jonathan
 */
public class FrameVenta extends javax.swing.JInternalFrame {
    private Logica logica;
    private Empleado empleado;
    private double total;
    private TextAutoCompleter autoProducto;
    private TextAutoCompleter autoCliente;
     ...
     */
    public FrameVenta(Logica logica, Empleado empleado) {
        initComponents();
        ...
        total=0.00;
        cliente=new Cliente(1, "C/F", "C/F", "", "CIUDAD", "", "C/F");
        ...
        autoCliente = new TextAutoCompleter(txNIT, new AutoCompleterCallback() {
            @Override
            public void callback(Object selectedItem) {
                for(int i=0; i<clientes.size(); i++){                    
                    if(clientes.get(i).getNit().equals(selectedItem)){
                        cliente=clientes.get(i);
                        txNombre.setText(cliente.getNombre());
                        txApellidos.setText(cliente.getApellidos());
                    }
                }
            }
        });
        autoCliente.setCaseSensitive(false);
        autoCliente.setMode(0);               
        for(int i=0; i<clientes.size(); i++){            
            autoCliente.addItem(clientes.get(i).getNit());
        }
    ...
    private void initComponents() {
        ...
        btVender.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        txNIT.setText("C/F");
        txNIT.setNextFocusableComponent(btVender);
        ...
        cbTipo.setNextFocusableComponent(btCodigo);
        ...
        txApellidos.setText("C/F");
        txApellidos.setNextFocusableComponent(btVender);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txApellidos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txApellidos, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVenderActionPerformed
        if(!logica.checkResolution( (String) cbTipo.getSelectedItem())){
            JOptionPane.showMessageDialog(this, "No cuenta con resoluciones de tipo "+(String) cbTipo.getSelectedItem(), "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }        
        ...
        if(logica.venta(empleado, cliente, modelo, (String) cbTipo.getSelectedItem(), total)){
            total=0.00;
            lbTotal.setText(total+"");
            cliente=new Cliente(1, "C/F", "C/F", "", "CIUDAD", "", "C/F");
            modelo = new DefaultTableModel();
            ...
            tableVentas.setModel(modelo);
            txNIT.setText(cliente.getNit());
            txNombre.setText(cliente.getNombre());
            txApellidos.setText(cliente.getApellidos());
            JOptionPane.showMessageDialog(this, "Venta exitosa.", "CORRECTO", JOptionPane.PLAIN_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(this, "Ocurrio un error en la venta.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
